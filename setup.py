...
setup(
  name = 'junyizhu_autocomplete',         # How you named your package folder (MyLib)
  packages = ['junyizhu_autocomplete'],   # Chose the same as "name"
  ...
  url = 'https://github.com/junyi-zhu/junyizhu_autocomplete',   # Provide either the link to your github or to your website
